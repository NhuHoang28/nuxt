    ...
    <BRow class="mt-5">
      <BCol>
        <form @submit.prevent="submit">
          ...
          <BRow>
            <BCol cols="6" class="pe-0">
              <select
                ...
                required
              >
                <option value="" disabled selected>Nguồn thu nhập</option>
            ...
            <BCol cols="6">
              <select
                ...
                required
              >
                <option value="" disabled selected>Người thu nhập</option>
          ...
          <BRow>
            <BCol>
              <Datepicker v-model="history.created_history_at" placeholder="Ngày thu nhập" />
            </BCol>
          </BRow>
          <BRow>
            <BCol>
...
const submit = () => {
  ...
  // Định nghĩa kiểu gửi là thu nhập
  history.value.history_type_id = getConfig('constants.historyTypes.income');
